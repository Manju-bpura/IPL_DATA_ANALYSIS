...
valid_ball_by_ball1_df = ball_by_ball_df.filter((col("wides")==0)&(col("noballs")==0))
#Aggregation: calculate the total and avereage runs scored in each match and inning
total_and_avg_runs = valid_ball_by_ball1_df.groupBy("match_id","innings_no").agg(sum("runs_scored").alias("total_runs"),
